...
set -l subcommands new delete orchestrator tab-setup
...
complete -c flock -f -n "not __fish_seen_subcommand_from $subcommands" -a orchestrator  -d "Open the orchestrator tab"
